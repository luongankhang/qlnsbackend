package com.api.taikhoan.configs;
...
public class Database {
    public final String url_database = "jdbc:mysql://localhost:3309/qltaikhoan";
    public final String username_database = "root";
    public final String password_database = "0396294429";
    public final String models_entity_database = "com.api.taikhoan.models";
